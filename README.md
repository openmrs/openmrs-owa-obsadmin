...
This will create a file called `obsadmin.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/andeladeveloper/openmrs-standalone-2.4/appdata/owa`
