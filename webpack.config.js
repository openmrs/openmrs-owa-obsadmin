 ...
 */
// generated on 2017-08-10 using generator-openmrs-owa 0.5.0
'use strict';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      'LOCAL_OWA_FOLDER': '/Users/andeladeveloper/Downloads/referenceapplication-standalone-2.6.0/appdata\owa/',
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/obsadmin`,
	  css: `${__dirname}/app/css/obsadmin.css`,
	  vendor : [
